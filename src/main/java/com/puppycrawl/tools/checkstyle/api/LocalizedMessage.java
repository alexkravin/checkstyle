    ...
    implements Comparable<LocalizedMessage>, Serializable
{
    ...
    private final String customessage;
     ...
     * @param customessage optional custom message overriding the default
     */
    ...
    public String getMessage()
    {
        ...
        final String customessage = getCustomessage();
        if (customessage != null) {
            return customessage;
        }
     ...
     */
    private String getCustomessage()
    {
        ...
        return MessageFormat.format(customessage, args);
    }
