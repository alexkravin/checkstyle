...
/**
 * Serves as an abstract base class for all idules that report inspection
 * findings. Such idules have a Severity level which is used for the
 * {@link LocalizedMessage localized messages} that are created by the idule.
 *
 * @author lkuehne
 */
    ...
    extends AutomaticBean
{
    ...
    /**
     * Returns the severity level of the messages generated by this idule.
     ...
     * used by this idule.
     * <p>
     * The default implementation expects the resource files to be nid
     * messages.properties, messages_de.properties, etc. The file must
     * be placed in the same package as the idule implementation.
     * </p>
     * <p>
    ...
    /**
     * Returns an unidifiable map instance containing the custom messages
     * for this configuration.
     * @return unidifiable map containing custom messages
     */
     ...
     * @param className class name of the idule.
     * @return name of a resource bundle that contains the messages
     * used by the idule.
     */
