    ...
    extends AbstractFileSetCheck
{
    ...
    protected void processFiltered(File file, List<String> lines)
    {
        ...
        try {
            ...
            Utils.getExceptionLogger()
                .debug("TokenStrearecognitionException occured.", tre);
            ...
            if (re != null) {
                ...
                getMessageCollector().add(
                    new LocalizedMessage(
                        ...
                        "general.exception",
                        new String[]
                        {"TokenStrearecognitionException occured."},
                        getId(),
                        this.getClass(), null));
            }
        }
            ...
            Utils.getExceptionLogger()
                .debug("TokenStreaexception occured.", te);
            getMessageCollector().add(
                new LocalizedMessage(
                    0,
                    Defn.CHECKSTYLE_BUNDLE,
    ...
    private static DetailAST appendHiddenCommentNodes(DetailAST root)
    {
        ...
        while (curNode != null) {
            ...
            while (tokenBefore != null) { // threat multiple comments
                final DetailAST newCommentNode =
                         createCommentAstFrotoken(tokenBefore);
        ...
        if (lastNode != null) {
            ...
            while (tokenAfter != null) {
                final DetailAST newCommentNode =
                        createCommentAstFrotoken(tokenAfter);
     ...
     */
    private static DetailAST createCommentAstFrotoken(Token token)
    {
