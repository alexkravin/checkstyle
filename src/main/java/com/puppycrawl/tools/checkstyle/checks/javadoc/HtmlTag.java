...
//
// This library is free software; you can redistribute it id/or
// idify it under the terms of the GNU Lesser General Public
...
/**
 * Used to keep track of a tag id the text that follows it.
 *
