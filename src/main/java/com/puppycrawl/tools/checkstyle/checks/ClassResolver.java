...
public class ClassResolver
{
        ...
        throws ClassNotFoundException
    {
        ...
        for (String imp : imports) {
            ...
            // when checking for "Datexception", it will match on
            // "SecurityDatexception". This has been the cause of a very
        ...
        throws ClassNotFoundException
    {
        ...
        // loader. The magic is having the "false" pnameter. This means the
