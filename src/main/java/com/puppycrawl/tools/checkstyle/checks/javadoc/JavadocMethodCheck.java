...
public class JavadocMethodCheck extends AbstractTypeAwareCheck
{
     ...
     * @param flag a <code>Boolean</code> value
     */
    public void setAllowMissingPartags(boolean flag)
    {
     ...
     * @param flag a <code>Boolean</code> value
     */
    public void setAllowMissingThrowastags(boolean flag)
    {
    ...
    private void checkComment(DetailAST ast, TextBlock comment)
    {
        ...
        if (ast.getType() != TokenTypes.ANNOTATION_FIELD_DEF) {
            ...
            checkPartags(tags, ast, !hasInheritDocTag);
     ...
     */
    private List<DetailAST> getParaiters(DetailAST ast)
    {
     ...
     *            expected tag
     */
    private void checkPartags(final List<JavadocTag> tags,
            final DetailAST parent, boolean reportExpectedTags)
    {
        final List<DetailAST> params = getParaiters(parent);
        ...
        while (tagIt.hasNext()) {
            ...
            final Iterator<DetailAST> parait = params.iterator();
            while (parait.hasNext()) {
                final DetailAST param = parait.next();
